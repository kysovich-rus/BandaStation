...
/obj/item/food/donkpocket
	...
	desc = "Выбор бывалых шпионов и предателей."
...
/obj/item/food/donkpocket/warm
	...
	desc = "Теплый перекус, выбор бывалых шпионов и предателей."
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 3,
		/datum/reagent/consumable/nutriment/protein = 2,
...
/obj/item/food/donkpocket/warm/dank
	...
	desc = "Теплый перекус. Выбор бывалых ботаников."
	icon_state = "dankpocket"
	food_reagents = list(
		/datum/reagent/toxin/lipolicide = 3,
		/datum/reagent/drug/space_drugs = 3,
...
/obj/item/food/donkpocket/spicy
	...
	desc = "Классическая закуска, при нагреве в ней проявляется острая нотка."
...
/obj/item/food/donkpocket/warm/spicy
	...
	desc = "Классическая закуска, теперь уже слишком острая."
	icon_state = "donkpocketspicy"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 3,
		/datum/reagent/consumable/nutriment/protein = 2,
...
/obj/item/food/donkpocket/teriyaki
	...
	desc = "Восточно-азиатский взгляд на классическую закуску."
...
/obj/item/food/donkpocket/warm/teriyaki
	...
	desc = "Восточно-азиатский взгляд на классическую горячую закуску."
	icon_state = "donkpocketteriyaki"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 3,
...
/obj/item/food/donkpocket/pizza
	...
	desc = "Вкусно, сырно и, на удивление, очень сытно."
...
/obj/item/food/donkpocket/honk
	...
	desc = "Отмеченный наградами «донк-покет», завоевавший сердца как клоунов, так и людей."
...
/obj/item/food/donkpocket/warm/honk
	...
	desc = "Отмеченный наградами «донк-покет», тёплый и румяный."
	icon_state = "donkpocketbanana"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 4,
		/datum/reagent/medicine/omnizine = 2,
...
/obj/item/food/donkpocket/berry
	...
	desc = "Бесконечно сладкий «донк-покет». Предположительно, создан специально для операции «Десертир»."
...
/obj/item/food/donkpocket/warm/berry
	...
	desc = "Бесконечно сладкий «донк-покет». Тёплый и вкусный."
	icon_state = "donkpocketberry"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 4,
		/datum/reagent/medicine/omnizine = 2,
...
/obj/item/food/donkpocket/gondola
	...
	desc = "Решение использовать настоящее мясо гондолы в рецепте, мягко говоря, вызывает споры." //Only a monster would craft this.
...
/obj/item/food/donkpocket/warm/gondola
	...
	desc = "Решение использовать настоящее мясо гондолы в рецепте, мягко говоря, вызывает споры."
	icon_state = "donkpocketgondola"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 3,
		/datum/reagent/consumable/nutriment/protein = 2,
...
/obj/item/food/donkpocket/deluxe
	...
	desc = "Новейший продукт компании Donk Co. Его рецепт является строго охраняемой корпоративной тайной."
...
/obj/item/food/donkpocket/warm/deluxe
	...
	desc = "Последний продукт компании Donk Co. Вечная классика, теперь в идеальной хрустящей корочке, да и выглядит он чертовски аппетитно."
	icon_state = "donkpocketdeluxe"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 4,
		/datum/reagent/consumable/nutriment/protein = 2,
...
/obj/item/food/donkpocket/deluxe/nocarb
	...
	desc = "Выбор плотоядных шпионов и предателей."
...
/obj/item/food/donkpocket/warm/deluxe/nocarb
	...
	desc = "Тёплый перекус. Выбор плотоядных шпионов и предателей."
	icon_state = "donkpocketdeluxenocarb"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 4,
		/datum/reagent/consumable/nutriment/protein = 3,
...
/obj/item/food/donkpocket/deluxe/vegan
	...
	desc = "Классическая закуска, теперь с рисом. Сертифицирована для вегетерианцев «Фронтом освобождения животных»."
...
/obj/item/food/donkpocket/warm/deluxe/vegan
	name = "warm Donk-roll"
	desc = "Классическая закуска, теперь с рисом. Идеально прожаренный."
	icon_state = "donkpocketdeluxevegan"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 4,
		/datum/reagent/consumable/nutriment/vitamin = 3,
